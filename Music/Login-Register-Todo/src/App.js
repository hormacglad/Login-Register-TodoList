            ...
            <div className="login-wrap">
              <div className="login-html">
                ...
                <div className="login-form">
                  <Login
                    // sample = {this.setState({...this.state, sample:'arrived'})}
                    user = {this.handleChangeUser}
                    form = {this.handleChangeFormDash}
                    // error_message={this.state.error_message}
                    // handleEmailChange={this.handleLoginEmailChange}
